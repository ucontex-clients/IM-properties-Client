...
export function EachProperty(){
    return(
        <div className="each-property-wrapper">
                <div className="each-property-image-holder"><img src="./images/eachProperty.png"></img></div>
                <div className="each-property-right">
                    ...
                    <div className="each-property-download-container">
                        <div className="each-property-download-wrapper"><img src="./images/downloadImage.png"></img></div>

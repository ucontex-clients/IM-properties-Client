    ...
    return(
        <div className="one-off-payment-container">
            ...
            <div className="payment-dropdown-div">
                ...
                <select name="payment" value='installment' onChange={(e) => changePaymentMode(e)}>
            ...
            <p className="initial-deposit-para" style={{marginTop: '12px'}}>Pay 40% (N736,600) initial deposite and pay the balance later</p>
            
            <div className="installment-duration-container" style={{marginTop:'51px'}}>
            ...
            <div className="pay-now-button-holder" style={{marginBlock: '50px 12px'}}>

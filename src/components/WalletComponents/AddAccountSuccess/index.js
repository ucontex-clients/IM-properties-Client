    ...
    return(
        <div className="add-bank-account-modal-wrapper" onClick={() => setViewAccountSuccess(false)}>
            <div className="add-account-modal-white">
                <div className="cancel-wrapper" onClick={() => setViewAccountSuccess(false)}><img src="./images/cancel.png"></img></div>
                ...
                <div>
                    <div style={{textAlign: 'center'}} className='success-paras'>
                        <div className="okay-wrapper"><div className="ok-wrapper"><img src="./images/Ok.png"></img></div></div>
